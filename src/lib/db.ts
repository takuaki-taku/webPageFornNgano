// // クライアントサイドでも使用できるデータ型定義
// import { teams, schedules } from "./data"

// export type Club = (typeof teams)[0]
// export type Schedule = (typeof schedules)[0]

// // このファイルにはfsやpathを使用するコードは含めません
// // 代わりに、APIを通じてデータにアクセスします

// import fs from "fs"
// import path from "path"
// // import { teams, schedules } from "./data" // Moved to top
